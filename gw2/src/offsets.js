    ...
    rendering: {
	      ...
	      byteLength: 0x55
			...
			environment: {
				...
				offset: 0x00C02D1E, // MapEnvironment
				byteLength: 0x38
			},
			river: {
				...
				offset: 0x00C02D5B, // MapRiveradvance
				byteLength: 0x5B
			},
			under_water: {
				...
				offset: 0x00C02DBB, // MapWaterAdvance
				byteLength: 0x32
			},
			zone: {
				...
				offset: 0x00C02DF2, // MapZoneAdvance
				byteLength: 0x37
			},
			lights: {
			...
			terrain: {
				...
				offset: 0x00C02EA4, // MapTrnUpdate
				byteLength: 0x35
			},
			cube_map: {
				...
				offset: 0x00C02EDE, // MapCubeMapAdvance
				byteLength: 0x44
			},
			props: {
				...
				offset: 0x00C02F27, // MapPropAdvance
				byteLength: 0x5E
			},
      ...
      animation: {
  			...
  			offset: 0x0066F623, // ViewAdvanceModel
  			byteLength: 0x2C
  		}
		},
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x8E, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04]),
    enableTimeOfDay: 0x00C0F9FC, // AFTER THIS -> F3 0F10 05 94220301   - movss xmm0,[Gw2.exe+FF2294]
    timeOfDay: 0x19CC,
    unknown: 0x1A20,
